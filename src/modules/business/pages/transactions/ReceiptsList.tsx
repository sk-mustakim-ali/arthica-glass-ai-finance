...
export function ReceiptsList() {
  ...
  const { transactions, loading, error } = useTransactionsByType(companyId!, 'receipt', 10);
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate(`/business/dashboard/${companyId}/transactions/receipts/create`)}>
